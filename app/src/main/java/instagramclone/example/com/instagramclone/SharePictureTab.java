            ...
            case R.id.btnShareImage:
                if (receivedImageBitmap != null) {
                    if (edtDescription.getText().toString().equals("")) {
                        FancyToast.makeText(getContext(), "Error: You have to set a description.", FancyToast.LENGTH_LONG, FancyToast.ERROR, false).show();
                    } else {
                        ...
                        parseObject.saveInBackground(new SaveCallback() {
                            ...
                            public void done(ParseException e) {
                                if (e == null) {
                                    FancyToast.makeText(getContext(), "Picture is uploaded", FancyToast.LENGTH_LONG, FancyToast.SUCCESS, false).show();
                                } else {
                                    FancyToast.makeText(getContext(), "There was an error: " + e.getMessage(), FancyToast.LENGTH_LONG, FancyToast.ERROR, false).show();
                                }
                                dialog.dismiss();
                    ...
                    FancyToast.makeText(getContext(), "Error: You have to select the image.", FancyToast.LENGTH_LONG, FancyToast.ERROR, false).show();
                }
                break;
        }
